...
namespace FinderProject.Infra.Data.Migrations
{
    ...
    [Migration("20230604130737_AddPersonalInformationToUserEntity")]
    partial class AddPersonalInformationToUserEntity
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("FinderProject.Domian.Entities.Category", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1L,
                            InsertTime = new DateTime(2023, 6, 4, 16, 37, 36, 354, DateTimeKind.Local).AddTicks(2266),
                        ...
                        {
                            Id = 2L,
                            InsertTime = new DateTime(2023, 6, 4, 16, 37, 36, 356, DateTimeKind.Local).AddTicks(8016),
                        ...
                        {
                            Id = 3L,
                            InsertTime = new DateTime(2023, 6, 4, 16, 37, 36, 356, DateTimeKind.Local).AddTicks(8178),
                            Name = "مراکز خرید",
                            RemovedTime = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            UpdateTime = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                        ...
                        {
                            Id = 4L,
                            InsertTime = new DateTime(2023, 6, 4, 16, 37, 36, 356, DateTimeKind.Local).AddTicks(8284),
                            Name = "هنر و تئاتر",
                            RemovedTime = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            UpdateTime = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            iconCate = "fi-museum",
                        ...
                        {
                            Id = 5L,
                            InsertTime = new DateTime(2023, 6, 4, 16, 37, 36, 356, DateTimeKind.Local).AddTicks(8330),
                        ...
                        {
                            Id = 6L,
                            InsertTime = new DateTime(2023, 6, 4, 16, 37, 36, 356, DateTimeKind.Local).AddTicks(8373),
                            Name = "باشگاه بدنسازی",
                            RemovedTime = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            UpdateTime = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            iconCate = "fi-dumbell",
                        ...
                        {
                            Id = 7L,
                            InsertTime = new DateTime(2023, 6, 4, 16, 37, 36, 356, DateTimeKind.Local).AddTicks(8407),
                            Name = "تور و سفر",
                            RemovedTime = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            UpdateTime = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                        ...
                        {
                            Id = 8L,
                            InsertTime = new DateTime(2023, 6, 4, 16, 37, 36, 356, DateTimeKind.Local).AddTicks(8440),
                            Name = "سلامتی و پزشکی",
                            RemovedTime = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            UpdateTime = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            iconCate = "fi-meds",
                        ...
                        {
                            Id = 9L,
                            InsertTime = new DateTime(2023, 6, 4, 16, 37, 36, 356, DateTimeKind.Local).AddTicks(8472),
                        ...
                        {
                            Id = 10L,
                            InsertTime = new DateTime(2023, 6, 4, 16, 37, 36, 356, DateTimeKind.Local).AddTicks(8507),
                            Name = "خدمات خودرو",
                            RemovedTime = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            UpdateTime = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            iconCate = "fi-car",
            ...
            modelBuilder.Entity("FinderProject.Domian.Entities.Favorite", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
            ...
            modelBuilder.Entity("FinderProject.Domian.Entities.PersonalInformation", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
            ...
            modelBuilder.Entity("FinderProject.Domian.Entities.PersonalInformation", b =>
                {
                    b.HasOne("FinderProject.Domian.Entities.User", "User")
                        ...
                        .HasForeignKey("FinderProject.Domian.Entities.PersonalInformation", "UserId");
