...
namespace FinderProject.Infra.Data.Migrations
{
    ...
    [Migration("20230519154944_AddSocialMediaNameToSocialMediaEntity")]
    partial class AddSocialMediaNameToSocialMediaEntity
    {
            ...
            modelBuilder.Entity("FinderProject.Domian.Entities.Category", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1L,
                            InsertTime = new DateTime(2023, 5, 19, 19, 19, 44, 197, DateTimeKind.Local).AddTicks(538),
                        ...
                        {
                            Id = 2L,
                            InsertTime = new DateTime(2023, 5, 19, 19, 19, 44, 200, DateTimeKind.Local).AddTicks(5799),
                        ...
                        {
                            Id = 3L,
                            InsertTime = new DateTime(2023, 5, 19, 19, 19, 44, 200, DateTimeKind.Local).AddTicks(5971),
                            Name = "مراکز خرید",
                            RemovedTime = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            UpdateTime = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                        ...
                        {
                            Id = 4L,
                            InsertTime = new DateTime(2023, 5, 19, 19, 19, 44, 200, DateTimeKind.Local).AddTicks(6008),
                            Name = "هنر و تئاتر",
                            RemovedTime = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            UpdateTime = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            iconCate = "fi-museum",
                        ...
                        {
                            Id = 5L,
                            InsertTime = new DateTime(2023, 5, 19, 19, 19, 44, 200, DateTimeKind.Local).AddTicks(6040),
                        ...
                        {
                            Id = 6L,
                            InsertTime = new DateTime(2023, 5, 19, 19, 19, 44, 200, DateTimeKind.Local).AddTicks(6082),
                            Name = "باشگاه بدنسازی",
                            RemovedTime = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            UpdateTime = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            iconCate = "fi-dumbell",
                        ...
                        {
                            Id = 7L,
                            InsertTime = new DateTime(2023, 5, 19, 19, 19, 44, 200, DateTimeKind.Local).AddTicks(6112),
                            Name = "تور و سفر",
                            RemovedTime = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            UpdateTime = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                        ...
                        {
                            Id = 8L,
                            InsertTime = new DateTime(2023, 5, 19, 19, 19, 44, 200, DateTimeKind.Local).AddTicks(6142),
                            Name = "سلامتی و پزشکی",
                            RemovedTime = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            UpdateTime = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            iconCate = "fi-meds",
                        ...
                        {
                            Id = 9L,
                            InsertTime = new DateTime(2023, 5, 19, 19, 19, 44, 200, DateTimeKind.Local).AddTicks(6171),
                        ...
                        {
                            Id = 10L,
                            InsertTime = new DateTime(2023, 5, 19, 19, 19, 44, 200, DateTimeKind.Local).AddTicks(6204),
                            Name = "خدمات خودرو",
                            RemovedTime = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            UpdateTime = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            iconCate = "fi-car",
